...
bool ThingType::operator==(const ThingType& other) const {
	return category == other.category && width == other.width && height == other.height &&
		   animationsFrames == other.animationsFrames && patternX == other.patternX && patternY == other.patternY &&
		   patternZ == other.patternZ && layers == other.layers && textureIdsVector == other.textureIdsVector;
}
