...
public:
	...
	bool operator==(const ItemType& other) const {
		return ThingType::operator==(other) && itemTypeFlags == other.itemTypeFlags && speed == other.speed &&
			   minimapColor == other.minimapColor && itemCategory == other.itemCategory && name == other.name;
	}
	...
	[[nodiscard]] bool hasFlag(ItemTypeFlags flag) const { return itemTypeFlags & flag; }

	[[nodiscard]] uint32_t getAllFlags() const { return itemTypeFlags; }

	void setAllFlags(uint32_t flags) { itemTypeFlags = flags; }
